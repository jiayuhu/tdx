"""
选股程序：买入微盘股基本面良好股票
描述：调用一系列 KDJ 相关公式，从 X02 筛选到 B00/B01/B02
...
使用示例:
    python xg_buy_small_goodfund.py
"""
...
# 从配置文件读取
# ============================================================================
xg_config = config.get("xg_buy_small_goodfund", {})
...
def main():
    ...
    for i, formula_config in enumerate(FORMULAS_CONFIG, 1):
        ...
        source_block = formula_config.get("source_block", "X02")
